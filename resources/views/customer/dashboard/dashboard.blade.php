                        ...
                        <div class="col-6 col-md-3 mb-3 d-flex align-items-stretch">
                            <div class="card produk-card shadow-sm rounded-lg border-0 w-100" style="border-radius: 30px;">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <a href="{{ route('customer.produk_detail', $data->id_produk) }}" class="btn btn-sm mt-3 rounded-pill text-white fw-semibold" style="background: linear-gradient(135deg, #f26514, #ffd014);">
                                            Lihat Produk
                                        </a>
                                    </div>
                                </div>
